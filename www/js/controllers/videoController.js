...
//		}
		 if(browser.versions.ios){	//iphone
			window.location.href="objc://startVideo/?"+ APP_video.mediaUserId+"?"+APP_video.mediaEmpId+"?"+APP_video.mediaIp+"?"+APP_video.mediaPort+"?"+APP_video.mediaUserId;
		}else if(browser.versions.android){
			// jtoJHandle.callFunctionWithP(3, APP_video.mediaUserId, APP_video.mediaEmpId, APP_video.mediaIp, APP_video.mediaPort, APP_video.mediaUserId);
			console.log('视频通话 ==========================  ');
...
//	            	console.log("视频通话成功");
//	            	CRHloadPage("/agreement");
//	            	APP_video.finishVideo(1);
//	            } else{
//	            	console.log("视频通话发生错误，");
