...
- (void)webViewDidFinishLoad:(UIWebView*)theWebView
{
    ...
    NSString *jsADD_SCRIPT = @"{var parent = document.getElementsByTagName('head').item(0);var script = document.createElement('script');script.type = 'text/javascript';script.src = 'cordova.js';parent.appendChild(script);}";
    //var parent1 = document.getElementsByTagName('body').item(0);var script1 = document.createElement('script');script1.type = 'text/javascript';script1.src = 'js/forge.bundle.js';parent1.appendChild(script1)};
    [self.webView stringByEvaluatingJavaScriptFromString:jsADD_SCRIPT];
